...
public formupdate()
{  
b1=new JButton("Update Student Records");
...
PreparedStatement stmt=con.prepareStatement("update st set StudentName=?,CGPA=?,Backlogs=?,Attendance=?,PhoneNumber=? where RollNumber=?");  
